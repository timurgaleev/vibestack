/**
 * vibestack browse — CSS Inspector content script
 *
...
(() => {
  ...
  if (window.__vibestackInspectorActive) return;
  window.__vibestackInspectorActive = true;
  ...
  function createHighlight() {
    ...
    highlightEl.id = 'vibestack-inspector-highlight';
    ...
    tooltipEl.id = 'vibestack-inspector-tooltip';
  ...
  function onMouseMove(e) {
    ...
    if (target.id === 'vibestack-inspector-highlight' || target.id === 'vibestack-inspector-tooltip') return;
  ...
  function injectCSS(id, css) {
    ...
    const styleId = `vibestack-inject-${id}`;
