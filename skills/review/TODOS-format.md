...
## <Skill/Component>     ← e.g., ## QA, ## Ship, ## Review, ## Infrastructure
...
**Sections:** Organize by skill or component (`## QA`, `## Ship`, `## Review`, `## Retro`, `## Infrastructure`). Within each section, sort items by priority (P0 at top).
