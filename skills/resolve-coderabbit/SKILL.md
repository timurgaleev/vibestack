...
```bash
~/.vibestack/bin/vibe-learnings-log '{"skill":"resolve-coderabbit","type":"TYPE","key":"SHORT_KEY","insight":"DESCRIPTION","confidence":N,"source":"SOURCE","files":["path/to/relevant/file"]}'
```
