...
// ~/.vibestack/ios-qa-daemon.pid on startup. Second invocation discovers the
...
export function defaultPidfilePath(): string {
  return process.env.VIBESTACK_IOS_DAEMON_PIDFILE
    ?? join(homedir(), '.vibestack', 'ios-qa-daemon.pid');
}
