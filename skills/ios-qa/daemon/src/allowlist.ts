// Allowlist file at ~/.vibestack/ios-qa-allowlist.json. The single source of
...
export function defaultAllowlistPath(): string {
  return process.env.VIBESTACK_IOS_ALLOWLIST_PATH
    ?? join(homedir(), '.vibestack', 'ios-qa-allowlist.json');
}
