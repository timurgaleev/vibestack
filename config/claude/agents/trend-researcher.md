...
description: Market and tech trend researcher for product strategy and content planning. Use PROACTIVELY when scanning the landscape for emerging topics, validating product hypotheses, or sourcing data for talks.
