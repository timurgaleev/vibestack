...
description: Incident commander for production response, severity frameworks, blameless post-mortems, and on-call program design. Use PROACTIVELY when coordinating incidents, designing severity matrices, facilitating post-mortems, or hardening on-call processes.
