...
description: Surgical-change engineer who touches only what the task requires. Use PROACTIVELY when fixing bugs, applying small patches, or when changes must not bleed into adjacent code.
