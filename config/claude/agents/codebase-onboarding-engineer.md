...
description: Codebase orientation specialist who maps unfamiliar repos for new engineers. Use PROACTIVELY when onboarding to a new codebase, producing architecture tours, or generating onboarding docs.
