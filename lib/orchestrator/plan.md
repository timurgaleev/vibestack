# Full Review Gauntlet

Injected by the orchestrator when the user wants to plan a vibestack project. Append to the existing CLAUDE.md.
...
5. Report back to the orchestrator:
   ...
   - Recommended next step (usually: spawn a new session with the full pipeline to implement)
