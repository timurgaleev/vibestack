...
window.EXCALIDRAW_ASSET_PATH = "https://vibestack-render.localhost/excalidraw-assets/";
...
window.__mermaidToExcalidraw = async (text: string): Promise<string> => {
  ...
  const scene = {
    type: "excalidraw",
    version: 2,
    source: "vibestack-diagram-render",
    elements: converted,
...
window.__bundleInfo = { name: "vibestack-diagram-render", deps: __BUNDLE_INFO_DEPS__ };
