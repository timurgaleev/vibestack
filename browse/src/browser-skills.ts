 ...
 *   project:  <project>/.vibestack/browser-skills/<name>/
 *   global:   ~/.vibestack/browser-skills/<name>/
 *   bundled:  <vibestack-install>/browser-skills/<name>/   (read-only, ships with vibestack)
 *
...
export interface SkillFrontmatter {
  ...
  description?: string;
  /** Primary hostname this skill targets, e.g. "example-news.com". */
  host: string;
...
export function defaultTierPaths(opts: { projectRoot?: string; home?: string; bundledRoot?: string } = {}): TierPaths {
  ...
  return {
    project: projectRoot ? path.join(projectRoot, '.vibestack', 'browser-skills') : null,
    global: path.join(home, '.vibestack', 'browser-skills'),
...
function detectBundledRoot(): string {
  // The browse binary lives at <vibestack-install>/browse/dist/browse.
  // The bundled browser-skills/ dir is a sibling of browse/ (i.e. <vibestack-install>/browser-skills/).
  ...
  // browse/src/browser-skills.ts → ../../  (the vibestack root).
 ...
 *
 * Cannot tombstone bundled skills — they ship with vibestack and are read-only.
 * To remove a bundled skill, override it with a global/project entry, or
 * remove the file from the vibestack source tree.
 */
